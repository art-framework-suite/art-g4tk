...
//          geant4.10.06.p01/source/processes/electromagnetic/muons/src/G4MuIonisation.cc
//          Replaced mid- and high- energy ionisation models to invoke the
//          BetheBlochNoDeltaModel in order to avoid delta production for
//          PDSP ioLaser simulations.
//
// -------------------------------------------------------------------
//
...
#include "Geant4/G4MuBetheBlochModel.hh"
...
MyG4MuIonisationNoDelta::MyG4MuIonisationNoDelta(const G4String& name)
...
G4double MyG4MuIonisationNoDelta::MinPrimaryEnergy(const G4ParticleDefinition*,
					  const G4Material*,
					  G4double cut)
{
