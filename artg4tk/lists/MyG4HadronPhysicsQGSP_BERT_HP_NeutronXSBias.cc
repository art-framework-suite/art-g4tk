...
void
MyG4HadronPhysicsQGSP_BERT_HP_NeutronXSBias::CreateModels()
{
...
void
MyG4HadronPhysicsQGSP_BERT_HP_NeutronXSBias::ConstructParticle()
{
...
void
MyG4HadronPhysicsQGSP_BERT_HP_NeutronXSBias::ConstructProcess()
{
  if (tpdata == 0)
